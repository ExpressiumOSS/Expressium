...
namespace Expressium.CodeGenerators.Java.Selenium.UnitTests
{
    ...
    public class CodeGeneratorSolutionTests
    {
        ...
        [Test]
        public void CodeGeneratorSolutionJava_GenerateAll_Expressium_Files()
        {
        ...
        [Test]
        public void CodeGeneratorSolutionJava_GenerateAll_Configuration_File()
        {
        ...
        [Test]
        public void CodeGeneratorSolutionJava_GenerateAll_PomXml()
        {
        ...
        [Test]
        public void CodeGeneratorSolutionJava_GenerateAll_BasePage()
        {
        ...
        [Test]
        public void CodeGeneratorSolutionJava_GenerateAll_WebControls()
        {
            var packagePath = "microsoft/foodshop/web/api";
