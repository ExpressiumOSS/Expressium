...
namespace Expressium.CodeGenerators.CSharp.Playwright.UnitTests
{
    ...
    public class CodeGeneratorTestTests
    {
        ...
        public void CodeGeneratorTestCSharp_GenerateUsings()
        {
            ...
            Assert.That(listOfLines.Count, Is.EqualTo(7), "CodeGeneratorTestCSharp GenerateUsings validation");
        ...
        public void CodeGeneratorTestCSharp_GenerateOneTimeSetUpMethod()
        {
            ...
            Assert.That(listOfLines[3], Is.EqualTo("await InitializeBrowser();"), "CodeGeneratorTestCSharp GenerateOneTimeSetUpMethod validation");
        }
        ...
        public void CodeGeneratorTestCSharp_GenerateTitleTestMethod()
        {
            ...
            Assert.That(listOfLines[3], Is.EqualTo("asserts.EqualTo(await loginPage.GetTitle(), \"Login\", \"Validating the LoginPage Title...\");"), "CodeGeneratorTestCSharp GenerateTitleTestMethod validation");
        }
        ...
        public void CodeGeneratorTestCSharp_GenerateFillFormTestMethods()
        {
            ...
            Assert.That(listOfLines[2], Is.EqualTo("public async Task Validate_Page_Property_Username()"), "CodeGeneratorTestCSharp GenerateFillFormTestMethods validation");
            Assert.That(listOfLines[4].Contains("EqualTo(await loginPage.GetUsername(), loginPageModel.Username"), "CodeGeneratorTestCSharp GenerateFillFormTestMethods validation");
        }
        ...
        public void CodeGeneratorTestCSharp_Deep_Recursive_GetNavigationMethods()
        {
            ...
            Assert.That(listOfLines[0], Is.EqualTo("var registrationPage = new RegistrationPage(logger, page);"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
            Assert.That(listOfLines[1], Is.EqualTo("await registrationPage.ClickLogin();"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
        }
        ...
        public void CodeGeneratorTestCSharp_GetNavigationMethods()
        {
            ...
            Assert.That(listOfLines[0], Is.EqualTo("var loginPage = new LoginPage(logger, page);"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
            Assert.That(listOfLines[1], Is.EqualTo("await loginPage.ClickRegistration();"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
            Assert.That(listOfLines[3], Is.EqualTo("var registrationPage = new RegistrationPage(logger, page);"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
            Assert.That(listOfLines[4], Is.EqualTo("await registrationPage.ClickSettings();"), "CodeGeneratorTestCSharp GetNavigationMethods validation");
        }
