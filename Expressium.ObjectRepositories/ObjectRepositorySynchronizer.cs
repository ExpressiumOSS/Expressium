    ...
    public class ObjectRepositorySynchronizer
    {
        ...
        public void Validate()
        {
            if (!Enum.GetNames(typeof(SynchronizerTypes)).Any(e => How == e))
                throw new ArgumentException(string.Format("The ObjectRepositorySynchronizer property 'How' is invalid..."));

            if (string.IsNullOrWhiteSpace(Using))
                throw new ArgumentException(string.Format("The ObjectRepositorySynchronizer property 'Using' is undefined..."));
        }
