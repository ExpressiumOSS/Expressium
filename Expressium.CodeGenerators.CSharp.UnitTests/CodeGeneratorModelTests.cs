...
namespace Expressium.CodeGenerators.CSharp.UnitTests
{
    ...
    public class CodeGeneratorModelTests
    {
        ...
        {
            var listOfLines = codeGeneratorModel.GenerateUsings();
        ...
        {
            var listOfLines = codeGeneratorModel.GenerateNameSpace();
        ...
        {
            var listOfLines = codeGeneratorModel.GenerateProperties(page);
